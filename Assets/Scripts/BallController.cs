...
public class BallController : MonoBehaviour {
	...
	//the idea is that each update() call will parse the 
	//value in the string serverData and then set the value 
	//of the text field accordingly
	IEnumerator GetText() {
